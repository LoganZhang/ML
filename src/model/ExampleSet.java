 ...
 * instances). Methods provided for reading data from file, extracting feature
 * information, deriving subsets of the data set.
 *
 * @author billk
...
public class ExampleSet {
    ...
    /**
     * Construct an initially empty set of examples structured around the given
     * features and labelsa
     *
    ...
    /**
     * Build a set of examples from a file. Assumes that examples in file are
     * stored one per line, in comma separated format. Also assumes that two
     * lines of information precede the data proper: the first must be a list of
     * the feature names (comma-separated format) and the second must be a list
     * of the possible labels (comma-separated format). Any blank lines are
     * ignored.
     *
