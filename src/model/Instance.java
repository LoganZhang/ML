...
public class Instance {
    ...
    /**
     * Construct an instance object using the specified features and values.
     * Note that the value array should have length one greater than the
     * features array. This is because the final element of the values array is
     * treated as the label.
     *
     * @param features the feature names, in order.
     * @param values the feature values, in order, followed by the instance
     * label
     */
    ...
    public String getValueByFeature(String feature) {
        if (instance.containsKey(feature)) {
